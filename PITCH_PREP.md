...
**The nonprofit overhead track.** Thirty-six organizations surfaced as HIGH PRIORITY anomalies after EIN-match sanity validation. Public-records examples. NP-39 — officer compensation doubled YoY to $2.07 million for a single officer. NP-44 — officer compensation jumped from $451,000 to $2.05 million in a single fiscal year, a 355% increase. NP-45 — total expenses jumped from $6.7 million to $32.5 million YoY. NP-03 — $338,000 in officer compensation at a $1.34 million-expense organization, twenty-five percent of expenses going to one officer. NP-01 — $4.75 million in CA state grants against $556,000 in total revenue. Every number from a publicly-filed 990.

**The DGS threshold-edge track — cleared.** The pipeline's lead procurement candidate (a vendor with repeated just-under-threshold purchase orders to Cal Fire) was dropped after the dates lined up with active wildfire emergency response. Supplying fire crews during a crisis is the obvious non-fraud explanation. Worth noting as an example of the tool correctly weakening and then abandoning a lead when context emerges.
